...
/*GetOK list of the player's achievements
...
func (o *GetOK) WithPayload(payload []*models.Achievement) *GetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get o k response
func (o *GetOK) SetPayload(payload []*models.Achievement) {
	o.Payload = payload
}
...
func (o *GetOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.Achievement, 0, 50)
	}
...
/*GetDefault achievement error response
